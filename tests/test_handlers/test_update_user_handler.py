...
async def test_update_user_empty_body(client, create_user_in_database, get_user_from_database):
    user_data = {
        "user_id": uuid.uuid4(),
        "name": "Baby",
        "surname": "Bone",
...
async def test_update_user_not_found(client, create_user_in_database, get_user_from_database):
    user_data = {
        "user_id": uuid.uuid4(),
        "name": "Baby",
        "surname": "Bone",
